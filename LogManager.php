...
class LogManager implements LoggerInterface
{
     ...
     *
     * @param  string  $name
     * @param  \QuantaQuirk\Log\Logger  $logger
     * @return \QuantaQuirk\Log\Logger
     */
    ...
    protected function createEmergencyLogger()
    {
        ...
        $handler = new StreamHandler(
            $config['path'] ?? $this->app->storagePath().'/logs/quantaquirk.log',
            $this->level(['level' => 'debug'])
        );

        return new Logger(
            new Monolog('quantaquirk', $this->prepareHandlers([$handler])),
            $this->app['events']
        );
    }
